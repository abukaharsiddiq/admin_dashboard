              ...
              <div class="card-body">
                  <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="text" name="title1" class="form-control" id="title1" placeholder="Title1" value="{{ old('title1') }}" />
                          @error('title1')
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="text" name="title2" class="form-control" id="title2" value="{{ old('title2') }}" placeholder="Title2" />
                          @error('title2')
                          <span class="text-danger">{{ $message }}</span>
                          @enderror
                      </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                          <input type="text" name="title3" class="form-control" id="title3" placeholder="Title3" value="{{ old('title3') }}"/>
                          @error('title3')
                          <span class="text-danger">{{ $message }}</span>
                          @enderror
                      </div>
